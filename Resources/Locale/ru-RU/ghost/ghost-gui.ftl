...
ghost-gui-toggle-lighting-manager-popup-personal-light = Включенный персональный свет.
ghost-gui-toggle-lighting-manager-popup-fullbright = Режим полной яркости.
ghost-gui-toggle-lighting-manager-popup = Рендеринг света переключен.
...
ghost-return-to-body-text = Вас воскрешают! Вернуться в свое тело?
