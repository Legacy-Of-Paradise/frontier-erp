...
deep-fryer-oil-volume-low = { CAPITALIZE(THE($deepFryer)) } загорается и дымит!
deep-fryer-oil-no-slag = Шлак не требуется сливать.
...
deep-fried-crispy-item-examine = Он покрыт хрустящей маслянистой корочкой.
deep-fried-fried-item = глубоко прожаренный { $entity }
deep-fried-fried-item-examine = Он покрыт толстым хрустящим слоем.
deep-fried-burned-item = сгоревший { $entity }
deep-fried-burned-item-examine = Он почернел до угольков.
