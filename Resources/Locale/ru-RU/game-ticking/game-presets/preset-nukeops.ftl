...
nukeops-welcome =
    Вы - ядерный оперативник. Ваша задача - взорвать { $station } и убедиться, что от нее осталась лишь груда обломков. Ваше руководство, Синдикат, снабдило вас всем необходимым для выполнения этой задачи.
    Операция "{ $name }" началась! Смерть NanoTrasen!
nukeops-briefing = Ваши задачи просты. Доставить бомбу и убедиться, что она взорвется. Начинайте миссию.
...
nukeops-cond-nukeactiveinstation = Ядерная бомба была оставлена взведенной на станции.
