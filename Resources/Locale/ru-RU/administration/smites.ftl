...
admin-smite-vomit-organs-self = Вас тошнит, и вы чувствуете себя опустошенно!
...
admin-smite-lung-removal-name = Удалить легкие
...
admin-smite-electrocute-description = Поражает цель электрическим током, делая бесполезным все, что было на нее надето.
...
admin-smite-pinball-description = Превращает цель в суперпрыгучий мяч, метая ее об стены пока она не клипнется сквозь станцию в бездну.
admin-smite-yeet-description = Изгоняет цель в глубины космоса, включив no-clip и швыряя ее.
...
admin-smite-buffering-description = Вызывает у цели случайный запуск буферизации, замораживая ее на короткое время, пока она подгружается.
...
admin-smite-reptilian-species-swap-description = Меняет расу на Унатха. Пригодится для тех, кто ведет себя как космический расист.
...
admin-smite-maid-description = Насильно превращает цель в кошко-служанку уборщицу. Это настоящая пытка для некоторых игроков, используйте ее с умом.
...
admin-smite-stomach-removal-description = Удаляет желудок цели, лишая ее возможности питаться.
admin-smite-super-speed-description = Делает цель очень быстрой, заставляя ее превращаться в фарш при столкновении со стеной.
admin-smite-speak-backwards-description = Заставляет цель говорить задом наперед, так что она не сможет позвать на помощь.
admin-smite-lung-removal-description = Удаляет легкие цели, топя ее.
admin-smite-remove-hand-description = Удаляет только одну из рук цели вместо всех.
admin-smite-disarm-prone-description = Шанс обезоружить цель становится 100%, а наручники надеваются на нее мгновенно.
...
admin-smite-super-bonk-description = Заставляет цель удариться о каждый стол на станции и за ее пределами.
admin-smite-terminate-description = Создает экстерминатора с ролью призрака, с единственной задачей - убить выбранную цель.
...
admin-smite-super-bonk-lite-description = Заставляет цель удариться о каждый стол на станции и за ее пределами. Прекращает действовать после смерти цели.
...
admin-trick-block-unanchoring-description = Не дает закрепить целевой объект.
...
admin-trick-internals-refill-oxygen-description = Заполняет кислородом баллон или легкие цели.
admin-trick-internals-refill-nitrogen-description = Заполняет азотом баллон или легкие цели.
admin-trick-internals-refill-plasma-description = Заполняет плазмой баллон или легкие цели.
...
admin-trick-grant-all-access-description = Дает цели полный доступ.
admin-trick-revoke-all-access-description = Забирает у цели весь доступ.
admin-trick-rejuvenate-description = Возрождает цель, исцеляет ее от всего.
