ent-CrateArmorySMG = ящик пистолетов-пулеметов
    .desc = Содержит два мощных пистолета-пулемета и четыре магазина. Чтобы открыть необходим доступ уровня Оружейной.
...
ent-CrateTrainingBombs = ящик учебных бомб
    .desc = Содержит три маломощные учебные бомбы для обучения обезвреживанию и безопасной утилизации бомб, костюм сапера в комплект не входит. Чтобы открыть необходим доступ уровня Оружейной.
