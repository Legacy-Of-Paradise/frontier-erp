ent-CrateServiceJanitorialSupplies = ящик с уборочным инвентарем
    .desc = Победите копоть и грязь с Незаменимыми Припасами для Уборки от NanoTrasen! Содержит три ведра, таблички мокрого пола, и очищающие гранаты. Также содержит одну швабру, тряпку, щетку, чистящий спрей, и мусорный пакет.
...
ent-CrateServiceBureaucracy = ящик бюрократических припасов
    .desc = Стопка бумаги, папки, несколько ручек, офисная игрушка. О чем еще можно мечтать?
ent-CrateServiceFaxMachine = ящик с факсом
    .desc = Факсовый аппарат и отвертка для настройки его имени.
...
ent-CrateCandles = ящик свечей
    .desc = Содержит 4 коробки свечей, 2 больших и 2 маленьких. Для создания атмосферы или еще чего-нибудь.
