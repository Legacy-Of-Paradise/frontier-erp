...
ent-ActionActivateMicroBomb = Активировать имплант Микробомба
    .desc = Активирует вживленную микробомбу, полностью уничтожая вас и ваше снаряжение.
ent-ActionActivateDeathAcidifier = Активировать имплант Посмертный растворитель
    .desc = Активирует вживленный запас кислоты, полностью растворяя вас и ваше снаряжение.
...
ent-ActionVendingThrow = Выдать предмет
    .desc = Выдает случайный предмет из вашего инвентаря.
...
ent-FakeMindShieldToggleAction = [color=green]Переключить Ложную защиту разума[/color]
    .desc = Включить/выключить передачу импланта Ложную защиту разума
