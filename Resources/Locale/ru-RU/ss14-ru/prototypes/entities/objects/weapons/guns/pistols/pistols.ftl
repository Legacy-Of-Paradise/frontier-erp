...
ent-WeaponPistolViper = Гадюка
    .desc = Небольшой, легко скрываемый, но маломощный пистолет. Оснащен полностью автоматическим ресивером. Использует патроны калибра .35 авто.
    .suffix = Пистолет
ent-WeaponPistolEchis = Эфа
    .desc = Гадюка для киборгов. На ходу создает патроны калибра .35 из встроенного самозарядного фабрикатора боеприпасов.
...
ent-WeaponPistolMk58 = МК 58
    .desc = Дешевый и распространенный пистолет, производимый дочерней компанией NanoTrasen. Использует патроны калибра .35 авто.
    .suffix = Пистолет
