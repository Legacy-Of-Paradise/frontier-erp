...
ent-WeaponMakeshiftLaser = самодельный лазерный пистолет
    .desc = Молитесь, чтобы он не обжег вам руки.
    .suffix = Пистолет
...
ent-WeaponLaserCannon = лазерная пушка
    .desc = Тяжелое сверхмощное лазерное оружие.
    .suffix = Винтовка
...
ent-WeaponDisabler = станнер
    ...
    .suffix = Пистолет
ent-WeaponDisablerSMG = станнер-пулемет
...
ent-WeaponPistolCHIMPUpgraded = экспериментальный излучатель М.А.Р.Т.Ы.Х.
    .desc = Похоже, этот М.А.Р.Т.Ы.Х. бьет сильнее обычного.
    .suffix = Пистолет
...
ent-WeaponEnergyShotgun = энергетический дробовик
    .desc = Единственный в своем роде прототип энергетического оружия, использующий различные конфигурации дробовика. Оно позволяет совершать как смертельные, так и несмертельные выстрелы, что делает его универсальным оружием.
