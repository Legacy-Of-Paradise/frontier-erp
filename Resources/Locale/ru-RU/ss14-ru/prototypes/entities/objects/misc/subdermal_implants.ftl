...
ent-TrackingImplant = имплант "трекер"
    .desc = Этот имплант имеет устройство слежения, подключенное к сети датчиков костюма, а также монитор состояния для радиоканала безопасности.
...
ent-FreedomImplant = имплант "свобода"
    .desc = Этот имплант позволяет пользователю вырваться из наручников до трех раз, прежде чем он перестанет функционировать.
...
ent-DeathRattleImplant = имплант "предсмертный хрип"
    .desc = Этот имплант сообщит по радиоканалу Синдиката, если пользователь окажется в критическом состоянии или умрет.
...
ent-RadioImplantCentcomm = имплант радио центкома
    .desc = Этот имплант предоставляет доступ к каналу ЦентКома без гарнитуры. Разрешен только сотрудникам ЦентКома.
