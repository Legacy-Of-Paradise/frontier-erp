...
ent-DimLightBulb = тусклая лампа
    .desc = Приглушенная лампочка для рассеивания тьмы технических туннелей.
ent-WarmLightBulb = теплая лампа
    .desc = Лампа теплого света для создания более уютной атмосферы.
...
ent-ServiceLightBulb = сервисная лампочка
    .desc = Тусклая зеленая лампочка, используемая в лампах вызова уборщика.
...
ent-SodiumLightTube = натриевая лампа-трубка
    .desc = Мощная энергосберегающая лампа для космических глубин. Соленая.
