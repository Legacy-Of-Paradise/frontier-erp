...
ent-DrinkGlass = стакан-метаморф
    .desc = Стакан-метаморф, который автоматически превращается в емкость, соответствующую находящемуся в нем напитку. На донышке виден затертый номер патента.
