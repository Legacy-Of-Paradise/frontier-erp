...
ent-MechHonker = Х.О.Н.К.
    .desc = Произведенный компанией "Тирания Хонка, инкорпорейтед", этот экзокостюм предназначен для тяжелой поддержки клоунов. Используется, чтобы сеять радость жизни и веселье. ХОНК!
