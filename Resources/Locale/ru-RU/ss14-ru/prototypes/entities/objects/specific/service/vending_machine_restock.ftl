...
ent-VendingMachineRestockNutriMax = набор пополнения БотаМакс
    .desc = С нашими удобрениями ваши золотые руки станут зелеными! Пора пожинать плоды! Загрузите в торговый автомат БотаМакс.
...
ent-VendingMachineRestockSeeds = набор пополнения МегаРаздатчик Семян
    .desc = На этикетке написано, что этими семенами пользовались и передавали по наследству еще наши предки. Загрузите их в МегаРаздатчик Семян!
...
ent-VendingMachineRestockVendomat = набор пополнения Вендомат
    .desc = Коробка полная различных запчастей. Загрузите ее в Вендомат.
