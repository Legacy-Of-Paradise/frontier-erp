ent-ClothingNeckCloakCentcom = плащ представителя Центком
    .desc = Помпезный и элитнейший зеленый плащ с изящной золотой отделкой, сшитый специально для представителя Центрального командования. Он такой тяжелый, что золотая отделка вполне может быть настоящей.
