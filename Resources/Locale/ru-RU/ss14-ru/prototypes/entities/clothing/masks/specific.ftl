...
ent-ClothingMaskGoldenCursed = золотая маска
    .desc = Раньше использовались в странных пантомимах, но после того, как один из актеров сошел с ума на сцене, эти маски перестали использовать. Вы можете поклясться, что ее лицо искажается, когда вы не смотрите.
