...
ent-ComputerMedicalRecords = консоль медицинских карт
    .desc = Ее можно использовать для проверки медицинской истории.
ent-ComputerCriminalRecords = консоль криминальных записей
    .desc = Ее можно использовать для проверки судимостей. Редактировать их может только служба безопасности.
ent-ComputerStationRecords = консоль станционного учета
...
ent-ComputerCloningConsole = консоль клонирования
    .desc = Центральный элемент системы клонирования, величайшее достижение медицины. У нее много портов и проводов.
