...
ent-SignNews = знак "новости"
    .desc = Знак, указывающий на место работы репортера.
...
ent-WarningAir = знак "внимание: Воздух"
    .desc = ВНИМАНИЕ! Труба для транспортировки воздуха. Перед работой убедитесь, что поток газа через нее отключен.
ent-WarningCO2 = знак "внимание: CО2"
    .desc = ВНИМАНИЕ! Труба для транспортировки CO2. Перед работой убедитесь, что поток газа через нее отключен.
ent-WarningN2 = знак "внимание: N2"
    .desc = ВНИМАНИЕ! Труба для транспортировки азота. Перед работой убедитесь, что поток газа через нее отключен.
ent-WarningN2O = знак "внимание: N2O"
    .desc = ВНИМАНИЕ! Труба для транспортировки N2O. Перед работой убедитесь, что поток газа через нее отключен.
ent-WarningO2 = знак "внимание: О2"
    .desc = ВНИМАНИЕ! Труба для транспортировки кислорода. Перед работой убедитесь, что поток газа через нее отключен.
ent-WarningPlasma = знак отходов плазмы
    .desc = ВНИМАНИЕ! Труба для транспортировки плазмы. Перед работой убедитесь, что поток газа через нее отключен.
ent-WarningTritium = знак отходов трития
    .desc = ВНИМАНИЕ! Труба для транспортировки трития. Перед работой убедитесь, что поток газа через нее отключен.
ent-WarningWaste = знак отходов атмоса
    .desc = ВНИМАНИЕ! Труба для транспортировки отходов. Перед работой убедитесь, что поток отходов через нее отключен.
ent-SignSmoking = знак "не курить"
    .desc = Предупреждающий знак с надписью "НЕ КУРИТЬ".
ent-SignSomethingOld = старый плакат
    .desc = Какая-то техническая информация, жаль, что плакат слишком изношен, чтобы можно было ее прочитать.
ent-SignSomethingOld2 = старый плакат
    .desc = Выглядит так, будто планета разламывается врезающейся в нее станцией. Страшновато.
...
ent-SignRedFour = знак "четыре"
    .desc = Знак с цифрой, на котором нарисована четверка.
ent-SignRedFive = знак "пять"
    .desc = Знак с цифрой, на котором нарисована пятерка.
ent-SignRedSix = знак "шесть"
    .desc = Знак с цифрой, на котором нарисована шестерка.
ent-SignRedSeven = знак "семь"
    .desc = Знак с цифрой, на котором нарисована семерка.
ent-SignRedEight = знак "восемь"
    .desc = Знак с цифрой, на котором нарисована восьмерка.
