...
ent-BaseStationAdminBankATM = консоль администрирования станции
    .desc = Используется для перевода средств на банковский счёт станции и обратно.
ent-StationAdminBankATMFrontier = { ent-BaseStationAdminBankATM }
    .desc = Используется для перевода средств на банковский счёт Нового Горизонта (Фронтира) и обратно.
    .suffix = Фронтир
ent-StationAdminBankATMNfsd = { ent-BaseStationAdminBankATM }
    .desc = Используется для перевода денежных средств на банковский счёт ДШНГ и обратно.
    .suffix = ДШНГ
ent-StationAdminBankATMMedical = { ent-BaseStationAdminBankATM }
    .desc = Используется для перевода средств на медицинский банковский счёт и обратно.
    .suffix = Медицинский
