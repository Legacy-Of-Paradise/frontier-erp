...
ent-MobCatClippy = Клиппи
    .desc = Похоже, вы пишете письмо, вам нужна помощь?
...
ent-MobCatMistake = Ошибка
    .desc = ???
ent-MobCatBloodCult = кошка кровавого культа
    .desc = Основал Кровавый культ от скуки.
ent-EldritchPushGun = жуткий ручной пистолет
    .desc = Стреляет жуткой рукой.
