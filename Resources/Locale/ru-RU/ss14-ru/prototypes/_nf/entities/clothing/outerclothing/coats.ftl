...
ent-ClothingOuterCoatWitchHunter = пальто инквизитора
    .desc = Выглядит еще лучше под постоянным дождем и штормовым ветром.
ent-ClothingOuterCoatCardinal = пальто кардинала
    .desc = Никто не ожидает испанскую инквизицию!
ent-ClothingOuterCoatNfsdBomber = бомбер ДШ
    .desc = Выглядит ловко, Том.
ent-ClothingOuterCoatNfsdBomberBrigmed = бомбер санитара ДШ
    .desc = Кровь может испачкаться.
ent-ClothingOuterCoatNfsdFormal = официальное пальто ДШ
    .desc = Шикарное
ent-ClothingOuterCoatNfsdFormalSheriff = официальное пальто Шерифа ДШ
    .desc = Очень шикарное.
ent-ClothingOuterCoatNfsdLongCoat = длинное пальто ДШ
