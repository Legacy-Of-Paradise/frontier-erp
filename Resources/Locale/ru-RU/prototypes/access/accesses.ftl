...
id-card-access-level-emergency-shuttle-repeal = Отзыв экстренного шаттла
...
id-card-access-level-atmospherics = Атмосферный контроль
...
id-card-access-level-station-ai = Станционный ИИ
id-card-access-level-borg = Борг
id-card-access-level-basic-silicon = Базовый кремний
id-card-access-level-basic-xenoborg = Базовый ксеноборг