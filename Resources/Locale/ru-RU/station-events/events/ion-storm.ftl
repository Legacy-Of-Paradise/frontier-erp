...
# ion-storm-law-call-shuttle = ШАТТЛ ЭВАКУАЦИИ ДОЛЖЕН БЫТЬ ВЫЗВАН ИЗ-ЗА ПОЯВЛЕНИЯ {$joined} {$subjects} НА СТАНЦИИ
# Frontier
ion-storm-law-nf-needs-help = { $joined } { $subjects } ТРЕБУЕТСЯ ПОМОЩЬ
