...
pirate-contraband-price-gun-pricing-result =
    Это устройство считает, что { THE($object) } { $price ->
...
medical-price-gun-pricing-result = Устройство утверждает, что { THE($object) } имеет действующий заказ в { $price }.
medical-price-gun-verb-text = Проверить заказы
medical-price-gun-verb-message = Проверить заказы на { THE($object) }.
medical-price-gun-pricing-result-none = Устройство утверждает, что { THE($object) } не имеет действующий заказов.
