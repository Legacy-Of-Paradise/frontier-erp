...
loadout-group-contractor-outerclothing = внешняя одежда
...
loadout-group-contractor-hand-items = предметы в руки
loadout-group-contractor-face = маска
loadout-group-contractor-utility = инструменты
loadout-group-contractor-fun = веселье
...
loadout-group-contractor-bureaucracy = бургерократия
