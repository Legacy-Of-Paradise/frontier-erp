...
petting-success-goose = Вопреки всему, вам удается погладить { $target } по { POSS-ADJ($target) } маленькой ужасной голове.
...
petting-failure-crab = Вы тянетесь погладить { $target }, но { SUBJECT($target) } щелкает клешнями в вашу сторону!
...
petting-failure-pig = Вы тянетесь погладить { $target }, но сталкиваетесь с раздраженным хрюканьем и визгом!
...
petting-failure-dragon = Вы поднимаете руку, но { $target } издает рев, и вы решаете, что не хотите стать кормом для карпов.
...
petting-failure-bear = Вы думаете погладить { $target }, но { SUBJECT($target) } рычит, заставляя вас подумать еще раз.
...
petting-failure-station-ai = Вы тянетесь погладить { $target }, но { POSS-ADJ($target) } разряд заставляет вас отдернуть руку.
...
petting-failure-tesla = Вы тянетесь погладить { $target }, но { POSS-ADJ($target) } разряд заставляет вас отдернуть руку.
petting-success-mail-teleporter = Вы гладите { THE($target) } по { POSS-ADJ($target) } послушной, холодной внешности.
