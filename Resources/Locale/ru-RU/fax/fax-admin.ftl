...
admin-fax-lock-page-tooltip = Защитить бумагу от редактирования, чтобы ее нельзя было изменить даже такими вещами, как ручка cybersun.
# Frontier: stamp protection
admin-fax-stamp-protect-page = Заблокировать ручку CyberSun
