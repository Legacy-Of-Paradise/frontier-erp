...
bounty-description-artifact = NanoTrasen находится в затруднительном положении из-за кражи артефактов с планет, не практикующих космические полеты. Верните один, и мы выплатим за него компенсацию.
...
bounty-description-brain = Командир Колдуэлл лишилась мозга в результате недавней аварии с космической смазкой. К сожалению, мы не можем нанять замену, поэтому просто пришлите нам новый мозг, чтобы вставить его в нее.
...
bounty-description-donut = Служба безопасности Центкома несет большие потери в борьбе с Синдикатом. Отправьте пончики для поднятия боевого духа.
...
bounty-description-percussion = Из-за неудачной драки в баре, Объединенный смешанный ансамбль ударных инструментов всея Галактики потерял все свои инструменты. Пришлите им новый набор, чтобы они снова могли играть.
bounty-description-pie = 3.14159? Нет! Руководство Центком хочет покушать ПИрогов! Отправьте им один.
bounty-description-prison-uniform = Правительство Терры не смогло достать новую форму для заключенных, так что если у вас есть запасная одежда, мы заберем ее у вас.
...
bounty-description-borg-module = Ученые на соседней станции занимались только производством киборгов, но не модулей. Их исследования зашли в тупик, и им необходимы образцы для изучения. Пришлите любые модули киборгов, чтобы вдохновить своих коллег.
bounty-description-artifact-fragment = Ученые на соседней станции запрашивают фрагменты артефактов для микроксеноархеологических исследований. Обычные артефакты слишком велики для их микроисследовательских платформ. Пришлите несколько фрагментов артефактов, на которые богат ваш сектор.
...
bounty-description-warm-cloth = Строительная бригада унатхов не может восстановить электропитание на своей станции и замерзает. Нужно прислать им хоть какую-нибудь теплую одежду.
bounty-description-battery = Поселение арахнидов готовится к солнечной вспышке и запрашивает большую партию энергетических батарей. Передаем вам запрос на доставку.
bounty-description-fruit = Героическая обезьяна помогла священнику поймать нарушителя спокойствия, прятавшегося в часовне, и команда хочет вознаградить ее за отличную работу.
...
bounty-description-bedsheet = Кто-то в Атмос-отсеке постоянно выключает обогреватель, и мы все мерзнем в наших кроватях. Пожалуйста, пришлите нам несколько дополнительных одеял, чтобы мы могли согреться.
...
bounty-description-torch = Шеф-повар оживил всех обезьян и кобольдов разом, а они взбунтовались и захватили грузовой шаттл. Они потребовали припасов и безопасного перелета на планету с джунглями, и мы уступили их требованиям. Теперь им нужно только несколько факелов.
