cmd-planet-desc = Конвертирует указанную карту в планету с определенным биомом.
...
cmd-planet-map-prototype = Не удается индексировать { $prototype } как прототип существующего шаблона биома.
